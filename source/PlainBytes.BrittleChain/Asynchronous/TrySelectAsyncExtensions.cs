...
namespace PlainBytes.BrittleChain.Asynchronous
{
    ...
    /// </summary>
    public static class TrySelectAsyncExtensions
    {
        /// <summary>
        ...
        public static async Task<Result<TResult>> TrySelectAsync<T, TResult>(this Task<Result<T>> maybe, Func<T, TResult> onValue)
        {
        ...
        /// <typeparam name="TResult">Type of the functions result.</typeparam>
        /// <returns> A <see cref="Result{T}"/> with the functions result if it was successful, exception if it failed.</returns>
        public static async Task<Result<TResult>> TrySelectAsync<T, TResult>(this Task<Result<T>> maybe, Func<T, CancellationToken, TResult> onValue, CancellationToken token)
        {
            Result<TResult> result;
        ...
        public static async Task<Result<TResult>> TrySelectAsync<T, TResult>(this Task<Result<T>> maybe, Func<T, Task<TResult>> onValue)
        {
            Result<TResult> result;
        ...
        /// <typeparam name="TResult">Type of the task result.</typeparam>
        /// <returns> A <see cref="Result{T}"/> with the tasks result if it was successful, exception if it failed.</returns>
        public static async Task<Result<TResult>> TrySelectAsync<T, TResult>(this Task<Result<T>> maybe, Func<T, CancellationToken, Task<TResult>> onValue, CancellationToken token)
        {
            Result<TResult> result;
